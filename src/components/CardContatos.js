        ...
        <section>
            ...
            <div>
                <div class="d-flex m-auto pb-4  w-10/12 content-center">
                    ...
                    <span class="m-auto text-[#3A3A3A] max-sm:text-[14px]">Redes Sociais:</span>
                    <a href="/"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-whatsapp text-[#7B7B7B] hover:text-[#29CF00]" viewBox="0 0 16 16">
                    ...
                    <a href="/"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-instagram text-[#7B7B7B] hover:text-[#29CF00]" viewBox="0 0 16 16">
                    ...
                    <a href="/"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-facebook text-[#7B7B7B] hover:text-[#29CF00]" viewBox="0 0 16 16">
                ...
                <div id="fundocard" class="border-1 border-gray-300 shadow-3xl  bg-white rounded-xl max-lg:p-5 lg:p-16  w-10/12 text-center m-auto">
                    <h1 class="mb-4 text-2xl text-[#3A3A3A] font-bold max-sm:text-xl">Nos envie uma mensagem!</h1>
