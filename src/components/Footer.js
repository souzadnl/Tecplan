...
function Footer() {
    return (
        <footer>
            <div class="m-0 d-flex justify-evenly flex-wrap p-3 pt-5 pb-5 bg-[#202020]">
                <div class="w-20px">
                    <ul class="p-0">
                    <span class="text-white font-bold">Categorias</span>
                ...
                <div class="w-20px">
                    <ul class="p-0">
                    <span class="text-white font-bold">Sobre Nós</span>
                ...
                <div class="w-20px">
                    <ul class="p-0">
                    <span class="text-white font-bold">Contato</span>
                ...
                <div>
                <span class="text-white font-bold ">Onde nos encontrar?</span>
